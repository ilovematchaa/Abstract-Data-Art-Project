...
In my 2025 recap, I included some fun places I went to, such as, a cruise, my friend's birthday, and mexico

## Description of 2026 goals

I included some goals that I want to accomplish in this new year that I think is best for me.
## Scene API Usage

The methods that I used really helped me by allowing me to show the pictures of the memories I made last year and also allowed me to give the picture a caption so that it tells you where/what each place is. I got to change the color and the font of each caption.